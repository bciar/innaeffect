...
class Tmcategoryproducts extends Module
{
	...
	public function __construct()
	{
		...
		$this->description = $this->l('This module display category products on homepage');
	...
	public function getContent()
	{
		...
		else if (Tools::isSubmit('addcategoryproducts'))
			$output .= $this->renderForm();
		else if (Tools::isSubmit('updateSettings'))
			...
			'form' => array(
				...
				'input' => array(
					...
					array(
						'col' => 2,
						'type' => 'text',
						'desc' => $this->l('Numbers of product to display'),
						'name' => 'num',
						'label' => $this->l('Numbers of product to display'),
					),
					array(
						'type' => 'select',
						'name' => 'mode',
	...
	public function renderTabList($tab = false)
	{
		...
		if ($tab)
			$fields_list['use_carousel'] = array('title' => $this->l('Use carousel'), 'type' => 'bool', 'align' => 'center', 'active' => 'use_carousel');
	...
	{
		return array(
			'TM_CPS_CAROUSEL_NB' => Tools::getValue('TM_CPS_CAROUSEL_NB', Configuration::get('TM_CPS_CAROUSEL_NB')),
			'TM_CPS_CAROUSEL_SLIDE_WIDTH' => Tools::getValue('TM_CPS_CAROUSEL_SLIDE_WIDTH', Configuration::get('TM_CPS_CAROUSEL_SLIDE_WIDTH')),
			'TM_CPS_CAROUSEL_SLIDE_MARGIN' => Tools::getValue('TM_CPS_CAROUSEL_SLIDE_MARGIN', Configuration::get('TM_CPS_CAROUSEL_SLIDE_MARGIN')),
			'TM_CPS_CAROUSEL_AUTO' => Tools::getValue('TM_CPS_CAROUSEL_AUTO', Configuration::get('TM_CPS_CAROUSEL_AUTO')),
			'TM_CPS_CAROUSEL_ITEM_SCROLL' => Tools::getValue('TM_CPS_CAROUSEL_ITEM_SCROLL', Configuration::get('TM_CPS_CAROUSEL_ITEM_SCROLL')),
			'TM_CPS_CAROUSEL_SPEED' => Tools::getValue('TM_CPS_CAROUSEL_SPEED', Configuration::get('TM_CPS_CAROUSEL_SPEED')),
			'TM_CPS_CAROUSEL_AUTO_PAUSE' => Tools::getValue('TM_CPS_CAROUSEL_AUTO_PAUSE', Configuration::get('TM_CPS_CAROUSEL_AUTO_PAUSE')),
			'TM_CPS_CAROUSEL_RANDOM' => Tools::getValue('TM_CPS_CAROUSEL_RANDOM', Configuration::get('TM_CPS_CAROUSEL_RANDOM')),
			'TM_CPS_CAROUSEL_LOOP' => Tools::getValue('TM_CPS_CAROUSEL_LOOP', Configuration::get('TM_CPS_CAROUSEL_LOOP')),
			'TM_CPS_CAROUSEL_HIDE_CONTROL' => Tools::getValue('TM_CPS_CAROUSEL_HIDE_CONTROL', Configuration::get('TM_CPS_CAROUSEL_HIDE_CONTROL')),
			'TM_CPS_CAROUSEL_PAGER' => Tools::getValue('TM_CPS_CAROUSEL_PAGER', Configuration::get('TM_CPS_CAROUSEL_PAGER')),
			'TM_CPS_CAROUSEL_CONTROL' => Tools::getValue('TM_CPS_CAROUSEL_CONTROL', Configuration::get('TM_CPS_CAROUSEL_CONTROL')),
			'TM_CPS_CAROUSEL_AUTO_CONTROL' => Tools::getValue('TM_CPS_CAROUSEL_AUTO_CONTROL', Configuration::get('TM_CPS_CAROUSEL_AUTO_CONTROL')),
			'TM_CPS_CAROUSEL_AUTO_HOVER' => Tools::getValue('TM_CPS_CAROUSEL_AUTO_HOVER', Configuration::get('TM_CPS_CAROUSEL_AUTO_HOVER')),
		);
	}
	...
	protected function deleteTab()
	{
		...
		$res = $tab->delete();
		if (!$res)
			return $this->displayError($this->l('Error occurred when tab delete'));
