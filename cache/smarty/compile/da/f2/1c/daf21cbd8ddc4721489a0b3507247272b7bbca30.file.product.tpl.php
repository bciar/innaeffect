<?php /* Smarty version Smarty-3.1.19, created on 2017-03-05 11:06:47
         compiled from "/home1/innaeffe/public_html/themes/theme1255/product.tpl" */ ?>
<?php /*%%SmartyHeaderCode:169522377158bc37978d8819-12777242%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'daf21cbd8ddc4721489a0b3507247272b7bbca30' => 
    array (
      0 => '/home1/innaeffe/public_html/themes/theme1255/product.tpl',
      1 => 1450858586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '169522377158bc37978d8819-12777242',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58bc379877a924_73312516',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58bc379877a924_73312516')) {function content_58bc379877a924_73312516($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/home1/innaeffe/public_html/tools/smarty/plugins/modifier.date_format.php';
if (!is_callable('smarty_function_math')) include '/home1/innaeffe/public_html/tools/smarty/plugins/function.math.php';
if (!is_callable('smarty_function_cycle')) include '/home1/innaeffe/public_html/tools/smarty/plugins/function.cycle.php';
if (!is_callable('smarty_function_counter')) include '/home1/innaeffe/public_html/tools/smarty/plugins/function.counter.php';
?><!--Replaced theme 2 -->
...
" name="lnk_view" class="exclusive" />
		...
		<?php }?>
                <!-- left infos-->  
                <div class="pb-left-column<?php if ($_smarty_tpl->tpl_vars['columns']->value==2) {?> col-xs-12 col-md-7 col-lg-6<?php } elseif ($_smarty_tpl->tpl_vars['columns']->value==3) {?> col-xs-12<?php } else { ?> col-sm-6 col-md-6 col-lg-8<?php }?>">
                    <!-- product img-->        
...
" data-id="resetImages">
                ...
                <!-- center infos -->
                <div class="pb-right-column <?php if ($_smarty_tpl->tpl_vars['columns']->value==2) {?>col-xs-12 col-md-5 col-lg-6<?php } elseif ($_smarty_tpl->tpl_vars['columns']->value==3) {?>col-xs-12 <?php } elseif ($_smarty_tpl->tpl_vars['content_only']->value) {?> col-xs-6<?php } else { ?>col-sm-6 col-md-6 col-lg-4<?php }?>">
