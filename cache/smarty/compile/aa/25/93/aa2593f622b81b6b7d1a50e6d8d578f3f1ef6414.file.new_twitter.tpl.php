<?php /* Smarty version Smarty-3.1.19, created on 2017-03-07 22:26:52
         compiled from "/home1/innaeffe/public_html/modules/tmsocialfeeds/views/templates/admin/new_twitter.tpl" */ ?>
<?php /*%%SmartyHeaderCode:166269973258bf79fc699a17-34645847%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'aa2593f622b81b6b7d1a50e6d8d578f3f1ef6414' => 
    array (
      0 => '/home1/innaeffe/public_html/modules/tmsocialfeeds/views/templates/admin/new_twitter.tpl',
      1 => 1450858586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '166269973258bf79fc699a17-34645847',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58bf79fc9b90c3_30609878',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58bf79fc9b90c3_30609878')) {function content_58bf79fc9b90c3_30609878($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_escape')) include '/home1/innaeffe/public_html/tools/smarty/plugins/modifier.escape.php';
...
_header_off" class="radioCheck">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?php echo smartyTranslate(array('s'=>'Enable footer','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_footer" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_footer_on" value="1" checked="checked">
                        <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_footer_on" class="radioCheck">
                            <i class="color_success"></i> <?php echo smartyTranslate(array('s'=>'Yes','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
...
_border_off" class="radioCheck">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?php echo smartyTranslate(array('s'=>'Show replies','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
...
_replies_off" class="radioCheck">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?php echo smartyTranslate(array('s'=>'Show scroll','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
...
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_scroll_on" value="1" checked="checked">
                        <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
...
_scroll_off" class="radioCheck">
            ...
            <div class="form-group">
                <label class="col-lg-3 control-label"><?php echo smartyTranslate(array('s'=>'Show background','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
</label>
                <div class="col-lg-9">
                    <span class="switch prestashop-switch fixed-width-lg">
                        <input type="radio" name="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_background" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_background_on" value="1" checked="checked">
                        <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_background_on" class="radioCheck">
                            <i class="color_success"></i> <?php echo smartyTranslate(array('s'=>'Yes','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
...
_background" id="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_background_off" value="0">
                        <label for="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['type']->value, ENT_QUOTES, 'UTF-8', true);?>
_<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['hook']->value, ENT_QUOTES, 'UTF-8', true);?>
_background_off" class="radioCheck">
                            <i class="color_danger"></i> <?php echo smartyTranslate(array('s'=>'No','mod'=>'tmsocialfeed'),$_smarty_tpl);?>
