<?php /* Smarty version Smarty-3.1.19, created on 2017-03-07 05:47:15
         compiled from "/home1/innaeffe/public_html/themes/theme1255/supplier-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:192924231958be8fb34cc680-21056175%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'cbb8cb481c6b0b4e5e6a972664dab1946a9691f0' => 
    array (
      0 => '/home1/innaeffe/public_html/themes/theme1255/supplier-list.tpl',
      1 => 1450858586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '192924231958be8fb34cc680-21056175',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58be8fb3a99b20_61670424',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58be8fb3a99b20_61670424')) {function content_58be8fb3a99b20_61670424($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home1/innaeffe/public_html/tools/smarty/plugins/function.math.php';
                            ...
                            <div class="left-side col-xs-12 col-sm-3">
                                ...
                                <div class="logo">
                                    <?php if ($_smarty_tpl->tpl_vars['supplier']->value['nb_products']>0) {?>
                                        <a class="lnk_img" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getsupplierLink($_smarty_tpl->tpl_vars['supplier']->value['id_supplier'],$_smarty_tpl->tpl_vars['supplier']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['supplier']->value['name'], ENT_QUOTES, 'UTF-8', true);?>
">
                                    <?php }?>
                                    <img class="img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['img_sup_dir']->value;?>
...
<?php }?>
                                    ...
                                    <?php if ($_smarty_tpl->tpl_vars['supplier']->value['nb_products']>0) {?>
                                        <a class="btn btn-default btn-md icon-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getsupplierLink($_smarty_tpl->tpl_vars['supplier']->value['id_supplier'],$_smarty_tpl->tpl_vars['supplier']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
">
                                            <span>
