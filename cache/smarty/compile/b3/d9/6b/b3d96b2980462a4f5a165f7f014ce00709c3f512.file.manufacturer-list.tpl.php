<?php /* Smarty version Smarty-3.1.19, created on 2017-03-06 10:11:16
         compiled from "/home1/innaeffe/public_html/themes/theme1255/manufacturer-list.tpl" */ ?>
<?php /*%%SmartyHeaderCode:212473524158bd7c14b9dcf6-95237093%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'b3d96b2980462a4f5a165f7f014ce00709c3f512' => 
    array (
      0 => '/home1/innaeffe/public_html/themes/theme1255/manufacturer-list.tpl',
      1 => 1450858586,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '212473524158bd7c14b9dcf6-95237093',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_58bd7c14df0d43_63026188',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_58bd7c14df0d43_63026188')) {function content_58bd7c14df0d43_63026188($_smarty_tpl) {?><?php if (!is_callable('smarty_function_math')) include '/home1/innaeffe/public_html/tools/smarty/plugins/function.math.php';
			            	...
			            	<div class="left-side col-xs-12 col-sm-3">
								<div class="logo">
									<?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']>0) {?>
										<a class="lnk_img" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['manufacturer']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
...
-tm_medium_default.jpg" alt="" />
							...
							<div class="middle-side col-xs-12 col-sm-5">
								<h3>
									<?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']>0) {?>
										<a class="product-name" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['manufacturer']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo htmlspecialchars($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['truncate'][0][0]->smarty_modifier_truncate($_smarty_tpl->tpl_vars['manufacturer']->value['name'],20,'...'), ENT_QUOTES, 'UTF-8', true);?>
">
									<?php }?>
...
" title="<?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']==1) {?><?php echo smartyTranslate(array('s'=>'%d product','sprintf'=>intval($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products'])),$_smarty_tpl);?>
...
<?php }?>">
				                    ...
				                    <?php if ($_smarty_tpl->tpl_vars['manufacturer']->value['nb_products']>0) {?>
				                        <a class="btn btn-default btn-md icon-right" href="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['link']->value->getmanufacturerLink($_smarty_tpl->tpl_vars['manufacturer']->value['id_manufacturer'],$_smarty_tpl->tpl_vars['manufacturer']->value['link_rewrite']), ENT_QUOTES, 'UTF-8', true);?>
" title="<?php echo smartyTranslate(array('s'=>'view products'),$_smarty_tpl);?>
">
				                        	<span>
